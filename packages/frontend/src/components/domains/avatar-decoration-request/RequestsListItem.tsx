    ...
    <Card>
      <Card.Body className="overflow-hidden">
        ...
        <Stack direction="vertical" className="align-items-start position-relative" gap={3}>
          ...
          <Image src={request.url} alt={request.name} className="bg-dark rounded p-2" style={{ height: 128, width: 128 }} />
          <div>
          ...
          {request.description && (
            <div>
              ...
              <AutoCollapse>
                <div className="text-muted border-start px-2 mb-0"><MfmView>{request.description}</MfmView></div>
              </AutoCollapse>
            </div>
          )}
